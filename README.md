...
| `frameWidth`            | `300`             | Width of the rendered module column, in pixels. Increase to align with neighbouring modules in the same region. Long date/section labels wrap inside this width instead of overflowing.                                                                      |
